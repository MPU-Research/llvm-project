...
# CHECK-ASM-AND-OBJ: mlss m20, (t2), a0
# CHECK-ASM: encoding: [0x77,0xaa,0xa3,0x22]
mlss   m20, (x7), x10

# CHECK-ASM-AND-OBJ: mlss m20, (t2), a0, m0.t
# CHECK-ASM: encoding: [0x77,0xaa,0xa3,0x20]
mlss   m20, (x7), x10, m0.t

# CHECK-ASM-AND-OBJ: mls m20, (t2), a0
# CHECK-ASM: encoding: [0x77,0xca,0xa3,0x22]
mls    m20, (x7), x10

# CHECK-ASM-AND-OBJ: mls m20, (t2), a0, m0.t
...
# CHECK-ASM-AND-OBJ: msss m20, (t2), a0
# CHECK-ASM: encoding: [0x77,0xba,0xa3,0x22]
msss   m20, (x7), x10

# CHECK-ASM-AND-OBJ: msss m20, (t2), a0, m0.t
# CHECK-ASM: encoding: [0x77,0xba,0xa3,0x20]
msss   m20, (x7), x10, m0.t

# CHECK-ASM-AND-OBJ: mss m20, (t2), a0
# CHECK-ASM: encoding: [0x77,0xda,0xa3,0x22]
mss    m20, (x7), x10
